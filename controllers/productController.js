...
export const createProduct = catchAsyncErrors(async (req, res, next) => {
  ...
  if (!name || !description || !price || !category || !stock) {
    return new ErrorHandler("Please provide complete product details.", 400);
  }
 ...
 const product = await database.query(`
    ...
    ( $1, $2, $3, $4, $5, $6, $7 )
     RETURNING *
    `,[name, description, price / 89, category, stock,JSON.stringify(uploadedImages),created_by]);
...
console.log("Keywords:", keywords);
  ...
  return res.status(200).json({
    success: true,
    products: [],
    message: "Prompt too generic. Try more specific keywords.",
  });
}
